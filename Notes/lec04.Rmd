...
* **Exercise** Arrange the `mpg` data set 
by number of cylinders (variable `cyl`) and then engine displacement (variable `displ`)
within cylinders. Repeat the above for a data set comprised of
only the Hondas (see the variable `manufacturer`).
